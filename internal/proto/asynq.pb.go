...
type TaskMessage struct {
	...
	Headers map[string]*StringList `protobuf:"bytes,15,rep,name=headers,proto3" json:"headers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *TaskMessage) GetHeaders() map[string]*StringList {
	if x != nil {
		return x.Headers
	}
	return nil
...
func (x *SchedulerEnqueueEvent) Reset() {
	*x = SchedulerEnqueueEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_asynq_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SchedulerEnqueueEvent) Descriptor() ([]byte, []int) {
	return file_asynq_proto_rawDescGZIP(), []int{5}
}
...
var file_asynq_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x91, 0x04, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x4d, 0x65,
	...
	0x79, 0x6e, 0x71, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x05,
	...
	0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x8f, 0x03,
...
var file_asynq_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_asynq_proto_goTypes = []interface{}{
	(*TaskMessage)(nil),           // 0: asynq.TaskMessage
	(*StringList)(nil),            // 1: asynq.StringList
	(*ServerInfo)(nil),            // 2: asynq.ServerInfo
	(*WorkerInfo)(nil),            // 3: asynq.WorkerInfo
	(*SchedulerEntry)(nil),        // 4: asynq.SchedulerEntry
	(*SchedulerEnqueueEvent)(nil), // 5: asynq.SchedulerEnqueueEvent
	nil,                           // 6: asynq.TaskMessage.HeadersEntry
	nil,                           // 7: asynq.ServerInfo.QueuesEntry
	(*timestamppb.Timestamp)(nil), // 8: google.protobuf.Timestamp
}
var file_asynq_proto_depIdxs = []int32{
	6, // 0: asynq.TaskMessage.headers:type_name -> asynq.TaskMessage.HeadersEntry
	7, // 1: asynq.ServerInfo.queues:type_name -> asynq.ServerInfo.QueuesEntry
	8, // 2: asynq.ServerInfo.start_time:type_name -> google.protobuf.Timestamp
	8, // 3: asynq.WorkerInfo.start_time:type_name -> google.protobuf.Timestamp
	8, // 4: asynq.WorkerInfo.deadline:type_name -> google.protobuf.Timestamp
	8, // 5: asynq.SchedulerEntry.next_enqueue_time:type_name -> google.protobuf.Timestamp
	8, // 6: asynq.SchedulerEntry.prev_enqueue_time:type_name -> google.protobuf.Timestamp
	8, // 7: asynq.SchedulerEnqueueEvent.enqueue_time:type_name -> google.protobuf.Timestamp
	1, // 8: asynq.TaskMessage.HeadersEntry.value:type_name -> asynq.StringList
...
func file_asynq_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_asynq_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
